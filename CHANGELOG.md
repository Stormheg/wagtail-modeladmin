...
- Add support for Wagtail 7.4 LTS (see [#62](https://github.com/wagtail-nest/wagtail-modeladmin/pull/62))
- Resolve compatibility issues with upcoming Wagtail 8.0 (see [#63](https://github.com/wagtail-nest/wagtail-modeladmin/pull/63))
- Add project links on PyPI
